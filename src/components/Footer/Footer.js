...
import flagPic from "../../commonResource/images/icons/16.png";
		...
		<div className="container"> 
			...
			<div className="copyright-wrapper row">
				...
				<div className="footer-country  col-sm-12 order-1 col-md-4 order-md-2 text-md-right col-lg-2 order-lg-3">
					<div className="flag-wrapper"><img src={flagPic} alt="" /></div> <div className="footer-country-name">United States</div> 
				</div>
			</div>
		</div>
	</footer> 
